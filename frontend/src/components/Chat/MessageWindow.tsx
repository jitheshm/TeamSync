        ...
        <div className="hidden lg:col-span-2 lg:block bg-[url('/chat.jpg')] bg-cover  ">
            <div className="w-full bg-gray-700 bg-opacity-60 h-full">
                ...
                <div className="flex items-center justify-between w-full p-3 border-t border-gray-300">
                    <input type="text" onChange={(e) => setNewMessage(e.target.value)} placeholder="Message" className="block w-full py-2 pl-4 mx-3 bg-gray-400 rounded-full outline-none focus:text-gray-700" name="message" value={newMessage} required />
                    <button>
                    </button>

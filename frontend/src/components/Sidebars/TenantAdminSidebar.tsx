    ...
    return (
        ...
        <div className="absolute left-0 flex h-screen w-72 flex-col overflow-hidden rounded-r-2xl bg-sky-950 text-white">
            ...
            <ul className="mt-20 space-y-3">
                ...
                <li >
                    <Link href={'/'} className="relative flex cursor-pointer space-x-2 rounded-md py-4 px-10 text-gray-300 font-semibold hover:bg-slate-600">
                ...
                <li >
                    <Link href={'/'} className="relative flex cursor-pointer space-x-2 rounded-md py-4 px-10 text-gray-300 hover:bg-slate-600">

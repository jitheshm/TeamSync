        ...
        >
            ...
            <nav className="mt-14">
                <Link href="/employee/tester/dashboard">
                    <div className={`flex items-center px-6 py-2 mt-8 ${text} ${getIconBackground('/employee/tester/dashboard')}`}>
                ...
                <Link href="/employee/tester/dashboard/projects">
                    <div className={`flex items-center px-6 py-2 mt-8 ${text} ${getIconBackground('/employee/tester/dashboard/projects')}`}>
                ...
                <Link href="/employee/tester/dashboard/chats">
                    <div className={`flex items-center px-6 py-2 mt-8 ${text} ${getIconBackground('/employee/tester/dashboard/chats')}`}>
                ...
                <Link href="/employee/tester/dashboard/meeting">
                    <div className={`flex items-center px-6 py-2 mt-8 ${text} ${getIconBackground('/employee/tester/dashboard/meeting')}`}>
                ...
                <Link href="/employee/tester/dashboard/todo">
                    <div className={`flex items-center px-6 py-2 mt-8 ${text} ${getIconBackground('/employee/tester/dashboard/todo')}`}>

...
export default function TenantTesterSidebar() {
    ...
    return (
        <>
            ...
            <div className="bg-gray-950 w-screen h-14  fixed top-0 ">
                    ...
                    <div>
                        ...
                        <ul className=" space-y-6 tracking-wide mt-16">
                            <li className="min-w-max ">
                                <Link href="/employee/tester/dashboard" aria-label="dashboard" className="relative flex items-center space-x-4 bg-gradient-to-r from-sky-600 to-cyan-400 px-4 py-3 text-white">
                            ...
                            <li className="min-w-max">
                                <Link href="/employee/tester/dashboard/projects" className="group flex items-center space-x-4  px-4 py-3 text-gray-400 hover:bg-gray-700">
                            ...
                            <li className="min-w-max">
                                <Link href="/employee/tester/dashboard/tickets" className="group flex items-center space-x-4  px-4 py-3 text-gray-400 hover:bg-gray-700">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                        <path className="fill-current text-gray-300 group-hover:text-cyan-300" fillRule="evenodd" d="M2 6a2 2 0 012-2h4l2 2h4a2 2 0 012 2v1H8a3 3 0 00-3 3v1.5a1.5 1.5 0 01-3 0V6z" clipRule="evenodd" />
                                        <path className="fill-current text-gray-600 group-hover:text-cyan-600" d="M6 12a2 2 0 012-2h8a2 2 0 012 2v2a2 2 0 01-2 2H2h2a2 2 0 002-2v-2z" />
                                    </svg>
                            ...
                            <li className="min-w-max">
                                <Link href="/employee/tester/dashboard/chats" className="group flex items-center space-x-4 rounded-md px-4 py-3 text-gray-400 hover:bg-gray-700">

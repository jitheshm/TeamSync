                ...
                <div className="flex h-screen flex-col  justify-between pt-2 pb-6">
                    <div>
                        ...
                        <ul className=" space-y-6 tracking-wide mt-16">
                            ...
                            <li className="min-w-max">
                                <Link href="/employee/project_manager/dashboard/projects" className="group flex items-center space-x-4  px-4 py-3 text-gray-400 hover:bg-gray-700">
                            ...
                            <li className="min-w-max">
                                <Link href="/employee/project_manager/dashboard/chats" className="group flex items-center space-x-4 rounded-md px-4 py-3 text-gray-400 hover:bg-gray-700">

...
const Sidebar: React.FC<SidebarProps> = ({ sidebarOpen }) => {
    ...
    return (
        ...
        >
            ...
            <nav className="mt-14">
                <Link href="/employee/project_manager/dashboard">
                    <div className={`flex items-center px-6 py-2 mt-8 ${text} ${pathname === '/employee/project_manager/dashboard' ? 'bg-violet-500' : ''}`}>

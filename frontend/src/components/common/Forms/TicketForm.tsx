                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-5">
                            ...
                            <Textarea
                                ...
                                className="border border-gray-300  shadow p-3 h-60 w-full rounded"
                        ...
                        {
                            edit ? <button type="submit" className="block w-full bg-primary text-white font-bold p-4 rounded-lg">Update Ticket</button> : <button type="submit" className="block w-full bg-primary text-white font-bold p-4 rounded-lg">Create Ticket</button>
                        }
                    </form>
                </div>
            </div>
